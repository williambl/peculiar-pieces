...
public class PeculiarBlocks {
    ...
    public static final Block SPIN_PAD = registerBlock("spin_pad", PeculiarItems.MOD_ITEMS, new ToggleableBlockItem(3, new SpinPadBlock(false, FabricBlockSettings.of(Material.WOOL, MapColor.BLACK).strength(0.8f).sounds(BlockSoundGroup.LODESTONE)), new FabricItemSettings().group(PeculiarPieces.PIECES_GROUP)));
    public static final Block INVERTED_SPIN_PAD = registerBlock("inverted_spin_pad", PeculiarItems.MOD_ITEMS, new ToggleableBlockItem(3, new SpinPadBlock(true, FabricBlockSettings.of(Material.WOOL, MapColor.BLACK).strength(0.8f).sounds(BlockSoundGroup.LODESTONE)), new FabricItemSettings().group(PeculiarPieces.PIECES_GROUP)));
    //Pressure Plates
